export function formatRate(bytesPerSecond, mode = 'auto-bytes') {
    if (mode === 'auto-bits')
...
export function formatCompactRate(bytesPerSecond, mode = 'auto-bytes') {
    return formatRate(bytesPerSecond, mode).replace(' ', '');
}
